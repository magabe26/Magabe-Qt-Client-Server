package com.magabelab.magabeclient;
...
public class MagabeClientActivity extends QtActivity {

    private PowerManager.WakeLock mFullWakeLock;
    public static MagabeClientActivity m_activity = null;
    ...
    public static MagabeClientActivity getInstance() {
        return m_activity;
    }
